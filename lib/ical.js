...
// Propriedade de valor URI (URL:) não se escapa, mas também não pode carregar
// quebra de linha: seria uma propriedade nova injetada no arquivo.
function icsUri(text) {
...
function veventLines(m, opts) {
  ...
  if (m.link) lines.push("URL:" + icsUri(m.link));
...
module.exports = { icsEscape, icsUri, foldLine, utcStamp, brToDate, calendar, singleEvent };
